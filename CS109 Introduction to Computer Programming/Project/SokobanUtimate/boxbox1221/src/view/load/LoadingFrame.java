...
public class LoadingFrame extends JFrame {
    ...
    public LoadingFrame(int width, int height) {
        ...
        newBtn = FrameUtil.createButton(this, "Back and start New", new Point(75, 120), 170, 40);
...
//                   所以我们直接把他给重新初始化一遍地图，这样操作就行了。
                ...
                if (broken) {
                    ...
                    if (level.equals("1")) {
                        GameFrame gameFrame = new GameFrame(520, 630, mapMatrixNow, 1);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        gameFrame.setVisible(true);
                    } else if (level.equals("2")) {
                        GameFrame gameFrame = new GameFrame(570, 640, mapMatrixNow, 2);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(570, 630, mapMatrixNow, 3);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(580, 640, mapMatrixNow, 4);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(650, 620, mapMatrixNow, 5);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(650, 650, mapMatrixNow, 6);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(600, 620, mapMatrixNow, 7);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(630, 670, mapMatrixNow, 8);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(670, 620, mapMatrixNow, 9);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(620, 640, mapMatrixNow, 10);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(640, 650, mapMatrixNow, 11);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(580, 650, mapMatrixNow, 12);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(680, 640, mapMatrixNow, 13);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(640, 640, mapMatrixNow, 14);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
                        ...
                        GameFrame gameFrame = new GameFrame(630, 640, mapMatrixNow, 15);
                        gameFrame.setLevelFrame(this.levelFrame);
                        gameFrame.setTime(time);
                        gameFrame.getGamePanel().getStepLabel().setText(String.format("Step: %d", steps));
                        this.setVisible(false);
